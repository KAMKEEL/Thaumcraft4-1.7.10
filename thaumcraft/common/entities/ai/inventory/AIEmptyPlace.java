...
/*     */       {
/*  52 */         ArrayList<Byte> matchingColors = this.theGolem.getColorsMatching(this.theGolem.itemCarried);
/*  53 */         for (i$ = matchingColors.iterator(); i$.hasNext();) { byte color = ((Byte)i$.next()).byteValue();
/*  54 */           for (Integer side : GolemHelper.getMarkedSides(this.theGolem, tile, color)) {
/*  55 */             ItemStack is = InventoryUtils.placeItemStackIntoInventory(this.theGolem.itemCarried, te, side.intValue(), false);
/*  56 */             if (!ItemStack.func_77989_b(is, this.theGolem.itemCarried)) {
/*  57 */               this.xx = tile.field_145851_c;
/*  58 */               this.yy = tile.field_145848_d;
/*  59 */               this.zz = tile.field_145849_e;
/*  60 */               return true;
/*     */             }
/*     */           }
/*  63 */           if (InventoryUtils.getDoubleChest(tile) != null)
/*  64 */             for (Integer side : GolemHelper.getMarkedSides(this.theGolem, tile, color)) {
/*  65 */               ItemStack is = InventoryUtils.placeItemStackIntoInventory(this.theGolem.itemCarried, InventoryUtils.getDoubleChest(tile), side.intValue(), false);
/*  66 */               if (ItemStack.func_77989_b(is, this.theGolem.itemCarried)) {
...
/* Location:              /Users/shannon/Desktop/Thaumcraft-1.7.10-4.2.3.5.jar!/thaumcraft/common/entities/ai/inventory/AIEmptyPlace.class
